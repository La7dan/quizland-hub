  ...
  const loadQuiz = async (quizId: number) => {
    ...
    try {
      ...
      if (response.success && response.quiz) {
        // Show all questions for preview
    ...
    return (
      <div className="container mx-auto p-4 max-w-4xl">
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h1 className="text-2xl font-bold mb-6 text-center">Quiz Results (Preview)</h1>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 mb-6">
            <p className="text-yellow-700">
              <strong>Preview Mode:</strong> You are previewing this quiz as an administrator.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><strong>Visibility:</strong> {quiz.is_visible ? 'Visible to users' : 'Hidden'}</li>
              </ul>
            </div>
            
            <div className="space-y-4">
              <h2 className="text-lg font-medium">Your Information (For Testing)</h2>
      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="mb-8">
          ...
          <div className="mb-2 text-sm text-gray-500">
            <span className={currentQuestionData.is_visible ? "text-green-600" : "text-red-600"}>
              {currentQuestionData.is_visible ? "Visible to users" : "Hidden from users"}
            </span>
            {" • "}
            ...
            {currentQuestionData.answers.map((answer: any) => (
              <div 
                ...
                className={`flex items-center space-x-2 border p-3 rounded-md hover:bg-gray-50 ${
                  answer.is_correct ? "border-green-200 bg-green-50" : ""
                }`}
              >
                <RadioGroupItem 
