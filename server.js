...
app.get('/api/evaluations/pending/:coachId', requireAuth, async (req, res) => {
...
app.post('/api/evaluations/:id/approve', requireAuth, async (req, res) => {
  const { id } = req.params;
...
app.post('/api/evaluations/:id/disapprove', requireAuth, async (req, res) => {
  const { id } = req.params;
...
app.post('/api/evaluations/upload-file', upload.single('file'), (req, res) => {
  try {
    if (!req.file) {
...
// Upload evaluation record (existing endpoint)
app.post('/api/evaluations/upload', requireAuth, async (req, res) => {
